...
import { 
  ...
  Info, MapPin, ExternalLink, GraduationCap, Download
} from "lucide-react";
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <div className="flex items-center gap-2 w-full sm:w-auto">
          ...
          <div className="relative flex-1 sm:w-72">
            ...
            <Input placeholder="Search alumni..." className="pl-9 h-10" value={search} onChange={(e) => { setSearch(e.target.value); setPage(1); }} />
          </div>
        </div>
      </div>
